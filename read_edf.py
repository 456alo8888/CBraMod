...
def read_edf_cut_duration(file_path):
    try:
...
if __name__ == "__main__":
    ...
    eeg_folder = "./EEG2100/edf_files"
    results = count_total_edf_duration(eeg_folder)
    
    # edf_file_path = '/mnt/disk1/aiotlab/hieupc/CBraMod/EEG2100/edf_files/FA5550A0_1-1+.edf'
    # raw_data = read_edf_with_details(edf_file_path)
    # read_edf_cut_duration(edf_file_path)
    # plt.show()
